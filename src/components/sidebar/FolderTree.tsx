...
// FolderTree — renders the folder list inside the sidebar.
// Extracted from Sidebar.tsx so SearchBar and other sidebar
// widgets can sit alongside it without coupling.
...
export default function FolderTree({
  folders, notes, activeFolderId, onSelectFolder, onDeleteFolder,
}: Props) {
  return (
